    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: ( Padding(
          ...
          child: Text('Dresses',style:GoogleFonts.lobsterTwo(
            fontSize: 30,
          ...
          children: [
            ...
            Card(
                ...
                child: ClipRRect(
                  ...
                  child: Stack(
                    children: [
                      Image.asset('textures/dresses.png',height: 200,width: 200,fit: BoxFit.scaleDown,),
                          ...
                          child: Row(
                            children: [
                              Padding(
                                ...
                                child: Text('4.1',style: TextStyle(fontSize: 10.0,fontWeight: FontWeight.bold,color: Colors.white60,),
                                ),
                              ),
                              Padding(
